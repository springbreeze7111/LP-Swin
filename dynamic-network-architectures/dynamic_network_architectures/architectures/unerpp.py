...
from dynamic_network_architectures.neural_network import SegmentationNetwork
from dynamic_network_architectures.building_blocks.dynunet_block import UnetOutBlock, UnetResBlock
from dynamic_network_architectures.building_blocks.model_components import UnetrPPEncoder, UnetrUpBlock
...
if __name__ == '__main__':
    ...
    # print(f"FLOPs: {flop_counter.total() / 1e9} GFLOPs")