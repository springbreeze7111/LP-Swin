...
if __name__ == '__main__':
    ...
    # 定义模型
    model = PlainConvUNet(4, 6, (48, 96, 192, 384, 768, 768), nn.Conv3d,
                          3, (1, 2, 2, 2, 2, 2), (2, 2, 2, 2, 2, 2), 4,
                           (2, 2, 2, 2, 2), False, nn.BatchNorm3d,
                          None, None, None, nn.ReLU, deep_supervision=True)
    model.to(device)
